# Generated by Django 4.0.3 on 2023-10-24 07:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voters', models.ManyToManyField(related_name='voter_question', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('voters', models.ManyToManyField(related_name='voter_answer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
